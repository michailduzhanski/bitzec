...
during the *configure* step of building bitzecd:
...
For instance:
    ...
    $ bitzecd -zmqpubhashtx=tcp://127.0.0.1:28332 \
               -zmqpubrawtx=ipc:///tmp/bitzecd.tx.raw
...
These options can also be provided in bitzec.conf.
...
From the perspective of bitzecd, the ZeroMQ socket is write-only; PUB
sockets don't even have a read function. Thus, there is no state
introduced into bitzecd directly. Furthermore, no information is
...
using. Bitzecd appends an up-counting sequence number to each
